...
const SvgReviewAddIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#review_add_icon_svg__a)">
      <path
        fill="#fff"
    ...
    <defs>
      <clipPath id="review_add_icon_svg__a">
        <path fill="#fff" d="m16 33 16.97-16.97L49.942 33l-16.97 16.97z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgReviewAddIcon;
