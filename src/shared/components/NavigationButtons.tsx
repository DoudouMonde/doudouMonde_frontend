...
const NavigationButtons: React.FC<NavigationButtonsProps> = ({
  ...
  return (
    <div className={`grid grid-cols-2 gap-2 w-full ${className}`}>
      ...
      <button
        onClick={onPrevious}
        className="flex items-center justify-center gap-2 w-full h-[34px] bg-secondary-100 rounded-[20px]  hover:bg-white/80 hover:border-gray-400 transition-all duration-200"
      >
