...
export class DoudouMondeApiResponse<T> {
  @ApiProperty({
  ...
  static success<T>(status: HttpStatus, data?: T): DoudouMondeApiResponse<T> {
    return new DoudouMondeApiResponse(status, 'success', data);
  }
